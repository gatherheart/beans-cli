...
| [x] `list_directory` | List directory contents           | Medium   |
| [x] `rename_file`    | Rename/move files                 | Medium   |
| [x] `delete_file`    | Delete files                      | Medium   |
...
| [x] `/model`   | Switch model during session     | Medium   |
