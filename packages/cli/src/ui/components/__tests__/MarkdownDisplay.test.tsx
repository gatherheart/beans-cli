  ...
  describe("headers", () => {
    it("renders h1 headers", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="# Hello World" width={80} />,
      );
    ...
    it("renders h2 headers", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="## Section Title" width={80} />,
      );
...
\`\`\``;
  ...
  describe("inline formatting", () => {
    it("renders bold text", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="This is **bold** text" width={80} />,
      );
    ...
    it("renders italic text", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="This is *italic* text" width={80} />,
      );
    ...
    it("renders inline code", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="Use `const` keyword" width={80} />,
      );
    ...
    it("renders strikethrough text", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="~~deleted~~" width={80} />,
      );
    ...
    it("renders links", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="[Click here](https://example.com)" width={80} />,
      );
...
3. Third item`;
  ...
  describe("blockquotes", () => {
    it("renders blockquotes", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="> This is a quote" width={80} />,
      );
      const frame = lastFrame()!;
      expect(frame).toContain("│");
...
The end.`;
  ...
  describe("edge cases", () => {
    ...
    it("handles text without markdown", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="Plain text without formatting" width={80} />,
      );
    ...
    it("handles unicode characters", () => {
      const { lastFrame } = render(
        <MarkdownDisplay text="Hello 世界 🌍" width={80} />,
      );
    ...
    it("respects width parameter", () => {
      ...
      const { lastFrame } = render(
        <MarkdownDisplay text={longText} width={40} />,
      );
      expect(lastFrame()).toBeDefined();
    });
  });
